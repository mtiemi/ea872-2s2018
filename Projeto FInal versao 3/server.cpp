...
int main() {
  ...
  Corpo *c2 = new Corpo(10, 0, (int)SCREEN_WIDTH/2 -1, (int)SCREEN_HEIGHT/2 , SNAKE_HEAD);
  Corpo *c3 = new Corpo(10, 0, ((int)SCREEN_WIDTH/2)-2, (int)SCREEN_HEIGHT/2 , SNAKE_BODY);
  Corpo *c4 = new Corpo(10, 0, ((int)SCREEN_WIDTH/2)-3, (int)SCREEN_HEIGHT/2 , SNAKE_BODY);
  Corpo *c5 = new Corpo(10, 0, ((int)SCREEN_WIDTH/2)-4, (int)SCREEN_HEIGHT/2 , SNAKE_BODY);
